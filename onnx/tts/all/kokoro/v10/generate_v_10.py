...
"""
    for sid, name in id2speaker.items():
        s += f"\n### Speaker {sid} - {name}\n"
        s += f"""\n<audio controls>
  <source src="/sherpa/onnx/tts/all/kokoro/v1.0/mp3//{sid}-{name}.mp3" type="audio/mp3">
</audio>\n\n"""

    with open("book/src/Chinese-English/kokoro-multi-lang-v1_0.md", "w") as f:
        f.write(s)
