...
def android_apk(sherpa_onnx_version: str):
    ...
    d = get_data()
    d["apk"] = {
        "arm64-v8a": f"https://huggingface.co/csukuangfj2/sherpa-onnx-apk/resolve/main/tts-engine-new/{v}/sherpa-onnx-{v}-arm64-v8a-eng-tts-engine-matcha-icefall-en_US-ljspeech.apk",
        "armeabi-v7a": f"https://huggingface.co/csukuangfj2/sherpa-onnx-apk/resolve/main/tts-engine-new/{v}/sherpa-onnx-{v}-armeabi-v7a-eng-tts-engine-matcha-icefall-en_US-ljspeech.apk",
        "x86_64": f"https://huggingface.co/csukuangfj2/sherpa-onnx-apk/resolve/main/tts-engine-new/{v}/sherpa-onnx-{v}-x86_64-eng-tts-engine-matcha-icefall-en_US-ljspeech.apk",
        "x86": f"https://huggingface.co/csukuangfj2/sherpa-onnx-apk/resolve/main/tts-engine-new/{v}/sherpa-onnx-{v}-x86-eng-tts-engine-matcha-icefall-en_US-ljspeech.apk",
    }
