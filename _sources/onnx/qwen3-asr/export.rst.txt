Export Qwen3-ASR to sherpa-onnx
===============================

This page describes how to export `Qwen3-ASR`_ to onnx so that you can use
...
See `<https://github.com/Wasser1462/Qwen3-ASR-onnx>`_

Where to find exported models
------------------------------

You can find the exported `Qwen3-ASR`_ models at

  `<https://github.com/k2-fsa/sherpa-onnx/releases/tag/asr-models>`_

The following is an example about how to download an exported `Qwen3-ASR`_ model::
