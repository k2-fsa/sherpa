...
`rust-api-examples/examples/kokoro_tts_en.rs <https://github.com/k2-fsa/sherpa-onnx/blob/master/rust-api-examples/examples/kokoro_tts_en.rs>`_
...
`run-kokoro-tts-en.sh <https://github.com/k2-fsa/sherpa-onnx/blob/master/rust-api-examples/run-kokoro-tts-en.sh>`_
