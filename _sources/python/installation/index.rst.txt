...
`sherpa`_ supports both CPU and CUDA. To install a CUDA version of sherpa, all you
need to do is to install `PyTorch`_ with CUDA support.
...
We provide the following methods to install `sherpa`_. You can choose
