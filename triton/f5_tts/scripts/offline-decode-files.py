...
from typing import List, Tuple, Iterable, Dict, TextIO, DefaultDict, Union
import re
import logging
...
def get_args():
    ...
    parser.add_argument(
        ...
        help="See https://huggingface.co/datasets/yuekai/seed_tts",
    )
...
def main():
    ...
    if args.label:
        ...
        dataset = datasets.load_dataset("yuekai/seed_tts", split=args.label)
        for item in dataset:
            labels_dict[item["id"]] = normalize_text_alimeeting(item["target_text"])
