...
MODEL_ID=$1
if [[ "$MODEL_ID" == "whisper_qwen_1.5B" ]]; then
...
elif [[ "$MODEL_ID" == "whisper_qwen_7B" ]]; then
    ...
    echo "Error: Invalid Model_id provided. Please use 'whisper_qwen_1.5B' or 'whisper_qwen_7B'."
    exit 1
fi
