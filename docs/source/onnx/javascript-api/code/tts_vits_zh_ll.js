...
//
// Text-to-speech with the VITS Chinese (sherpa-onnx-vits-zh-ll) model.
// Uses lexicon and rule FSTs for Chinese text normalization.
//
// Usage:
...
const filename = 'test-vits-zh-ll.wav';
