...
//
// Text-to-speech with the VITS Chinese (icefall/aishell3) model.
// Uses lexicon and rule FSTs/FARs for Chinese text normalization.
//
// Usage:
...
const filename = 'test-vits-zh-aishell3.wav';
