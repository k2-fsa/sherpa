...
csukuangfj/sherpa-onnx-streaming-zipformer-ja-fluent-2023-02-21 (Japanese)
--------------------------------------------------------------------------
...
.. code-block:: bash
  ...
  GIT_LFS_SKIP_SMUDGE=1 git clone https://huggingface.co/csukuangfj/sherpa-onnx-streaming-zipformer-ja-fluent-2023-02-21
  cd sherpa-onnx-streaming-zipformer-ja-fluent-2023-02-21
  git lfs pull --include "*.onnx"
...
.. code-block:: bash
  ...
  sherpa-onnx-streaming-zipformer-ja-fluent-2023-02-21 fangjun$ ls -lh *.onnx
  -rw-r--r--  1 fangjun  staff   132B Feb 21 22:35 decoder-epoch-99-avg-1.onnx
  -rw-r--r--  1 fangjun  staff   134B Feb 21 22:35 encoder-epoch-99-avg-1.onnx
  -rw-r--r--  1 fangjun  staff   132B Feb 21 22:35 joiner-epoch-99-avg-1.onnx

  # after running `git lfs pull`

  sherpa-onnx-streaming-zipformer-ja-fluent-2023-02-21 fangjun$ ls -lh *.onnx
  -rw-r--r--  1 fangjun  staff   7.4M Feb 21 22:36 decoder-epoch-99-avg-1.onnx
  -rw-r--r--  1 fangjun  staff   337M Feb 21 22:37 encoder-epoch-99-avg-1.onnx
  -rw-r--r--  1 fangjun  staff   6.4M Feb 21 22:37 joiner-epoch-99-avg-1.onnx
...
.. code-block:: bash
  ...
  ./build/bin/sherpa-onnx \
    ./sherpa-onnx-streaming-zipformer-ja-fluent-2023-02-21/tokens.txt \
    ./sherpa-onnx-streaming-zipformer-ja-fluent-2023-02-21/encoder-epoch-99-avg-1.onnx \
    ./sherpa-onnx-streaming-zipformer-ja-fluent-2023-02-21/decoder-epoch-99-avg-1.onnx \
    ./sherpa-onnx-streaming-zipformer-ja-fluent-2023-02-21/joiner-epoch-99-avg-1.onnx \
    ./sherpa-onnx-streaming-zipformer-ja-fluent-2023-02-21/test_wavs/interview_aps-smp.wav
...
.. literalinclude:: ./code-zipformer/sherpa-onnx-streaming-zipformer-jp-fluent-2023-02-21.txt
